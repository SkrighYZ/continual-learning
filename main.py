...
task_params.add_argument('--experiment', type=str, default='splitMNIST', choices=['permMNIST', 'splitMNIST', 'splitCIFAR100'])
...
def run(args):
    ...
    # Train model
    train_cl(
        model, train_datasets, test_datasets, replay_mode=args.replay, experiment=args.experiment, scenario=scenario, classes_per_task=classes_per_task,
